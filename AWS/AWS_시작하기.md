...
Regional Cache: Edge Location과 Origin 사이의 중간 캐시 계층. Edge에서 캐시 미스 나면 Origin 까지 안 가고 Regional Cache에서 먼저 찾아봄.  
유저 -> Edge Location (400+ 개) -> Regional Cache (10+ 개) -> Origin 서버  
